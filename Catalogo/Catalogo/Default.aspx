                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <% if (ddlCampo.SelectedItem.ToString() == "Precio")
                                        {
                                    %>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtfiltroAvanzado" runat="server" ValidationExpression="^\d{1,13}(.\d{1,2})?$" ErrorMessage="Introduce números"></asp:RegularExpressionValidator>
                                    <% 
                                        }
                                        else
                                        {
